...
if(isset($_POST['login'])) 
{
  ...
  $t_class = $_POST['class'];
  $sql ="SELECT * FROM tblusers WHERE username=:username and Password=:password and t_class=:t_class";
    ...
    <div class="login-box">  
      ...
      <div class="card">
        <div class="card-body login-card-body">
          ...
          <p class="login-box-msg"><b> <h4> <center> Teacher </center></h4> </b></p>
