...
if(isset($_POST['submit']))
{
  ...
  }else
  {
    ...
    $status=1; 
    $sql="INSERT INTO  tblusers(name,username,email,password,status,mobile,sex,lastname,t_class,staff_no) VALUES(:name,:username,:email,:password,:status,:mobile,:sex,:lastname,:t_class,:staff_no)";
    ...
    $query->bindParam(':t_class',$t_class,PDO::PARAM_STR);
    $query->bindParam(':password',$password,PDO::PARAM_STR);
    $query->bindParam(':staff_no',$staff_no,PDO::PARAM_STR);
    $query->execute();
  ...
  <div class="card-body">
    ...
    <div class="row">
      <div class="form-group col-4">
        <label class="" for="register1-email">Assign Class:</label>
