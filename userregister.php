...
{
  $rid=$_GET['delid'];
  // $sql="update tbluers set status='0' where tblusers.id='$rid'";
  // $query=$dbh->prepare($sql);
  // $query->bindParam(':rid',$rid,PDO::PARAM_STR);
  // $query->execute();
  mysqli_query($con,"update tblusers set status='0' where id = '".$rid."'");
                      ...
                      foreach($results as $row)
                        {               ?>
                         <tr>
                          ...
                          <td class="text-left"><?php  echo htmlentities($row->t_class);?></td>
                          <td class="text-left">
